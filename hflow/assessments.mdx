...
2. Choose **language**, **school year**, **grade**, and **class** using the filters at the top.
...
- `total_words`, `correct_words`, `total_time`, `comprehension` (`Good`, `Partial`, `Low`, or blank)
...
Checkpoints are not imported—add them from the student profile drawer.
