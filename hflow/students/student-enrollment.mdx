...
This feature allows admins to enroll selected students into a **future** school year, grade, and class from **Students → Enrollment**.
...
If the target grade has no class sections yet, you can enroll without a class, or create the first section in the modal when offered.

When the grade already has sections, choose an existing section or **Create new section**.
...
3. Choose the **target school year** (next year or two years ahead).
