...
<Note>
  **Example file (do not import as-is):** [Download hflow-sample-students.csv](/samples/csv/hflow-sample-students.csv) shows fictitious names and columns in the format hFlow expects. **Do not load this file into your school roster**—use it only as a reference when you build your own CSV from your student data.
</Note>
