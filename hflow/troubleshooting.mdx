...
Those tools are for **organization administrators** (and owners). Teachers see a slimmer menu focused on **Students** and **Assessments**. See [Admin vs Teacher](/hflow/students/roles-and-permissions).
