...
When assessment access is **off** for a teacher, they can still use the **Students** roster for their assignments, but student names do not open the full profile drawer for editing assessments. See [Students: Admin vs Teacher](/hflow/students/roles-and-permissions).
