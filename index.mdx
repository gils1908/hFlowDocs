...
<Columns cols={2}>
  ...
  <Card title="Notifications" icon="bell" href="/hflow/notifications">
    In-app announcements: when they appear, how to read and dismiss them, and who sees which messages.
  </Card>
